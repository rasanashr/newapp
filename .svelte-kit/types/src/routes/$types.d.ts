...
type LayoutRouteId = RouteId | "/" | "/author/[slug]" | "/categories" | "/category/[slug]" | "/freegrokchat" | "/lastnews" | "/page/[slug]" | "/search" | "/tag/[slug]" | "/[...catchall]" | "/[id]/[slug]" | null
type LayoutParams = RouteParams & { slug?: string; catchall?: string; id?: string }
