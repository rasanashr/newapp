  ...
  <div class="w-full bg-[#f40000] flex flex-col items-center pt-4 pb-0 hidden md:flex">    
    <div class="w-full flex flex-row justify-between items-start px-0">
      ...
      <div class="flex flex-col items-center justify-center">
        <a href="/" aria-label="صفحه اصلی رسا نشر"><img src={logoUrl} alt="لوگو رسا نشر" class="h-[150px] mt-2 select-none" draggable="false" /></a>
      </div>
      <!-- Right Box -->
    ...
    <div class="w-[95%] flex flex-row items-center justify-center mt-4 mb-2">
      <div class="w-full flex flex-row items-center justify-center bg-[#f7f0f0] rounded-full py-2">
              <div class="flex-1 text-center  text-l font-bold">
                ...
                <a href="/category/ai-news/"   aria-label="خبرهای هوش مصنوعی"><span  class="text-black px-2">هوش مصنوعی</span></a><span class="text-lime-300">|</span>
                <a href="/category/cinema/"   aria-label="اخبار سینما"><span class="text-black px-2">سینما</span></a>
        ...
        <div class="flex-1 text-center text-l font-bold">
          <a href="/category/economic/"   aria-label="اخبار اقتصادی"><span  class="text-black px-2">اقتصادی</span></a><span class="text-lime-300">|</span>
          <a href="/category/sports/"   aria-label="اخبار ورزشی"><span  class="text-black px-2">ورزشی</span></a>  <span class="text-lime-300">|</span>
          ...
          <a href="/category/multimedia/"   aria-label="عکس و فیلم"><span class="text-black px-2">چند رسانه ای</span></a>
        </div>
      </div>
    </div>
  </div>
